...
| 02→03 | `home-zoom3d.js` | three.js 三尺度连续飞行：中国主要农区 → 三维田块（成片玉米随风摆动）→ 土壤剖面中的根系与 J2，尺度之间以「侦探镜头」圆形转场衔接，最后提问 How do nematodes infect plants?；无 WebGL 时退回 `home-zoom.js` 的 SVG 版本。 |
...
2026-09-23 的桌面（1440×900）与移动（390×844）截图审阅记录见 `docs/home-validation.md`；2026-09-24 本版截图保存在 `docs/screenshots/homepage-review-desktop-1440-2026-09-24.jpg` 与 `docs/screenshots/homepage-review-mobile-390-2026-09-24.jpg`。
